const CLOUD_FILE_PREFIX = 'cloud://cloud1-d7ga0y9wyc4ee559d.636c-cloud1-d7ga0y9wyc4ee559d-1427743983/share-goods/'
...
function getProductImageFileId(productId) {
  ...
  return cloudPath ? `${CLOUD_FILE_PREFIX}${cloudPath}` : ''
}
